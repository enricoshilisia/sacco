...
urlpatterns = [
    ...
    path("me/collections/", views.MyCollectionListView.as_view(), name="my_collection_list"),
    path("me/collections/<uuid:pk>/", views.MyCollectionDetailView.as_view(), name="my_collection_detail"),
